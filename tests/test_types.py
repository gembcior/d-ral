...
class TestDralTypes:
    ...
    @pytest.mark.parametrize("field_a", ["field0", "field1",])
    @pytest.mark.parametrize("field_b", ["field0", "field1",])
    ...
    @pytest.mark.parametrize("register_a", ["register0", "register1",])
    @pytest.mark.parametrize("register_b", ["register0", "register1",])
    ...
    @pytest.mark.parametrize("peripheral_a", ["peripheral0", "peripheral1",])
    @pytest.mark.parametrize("peripheral_b", ["peripheral0", "peripheral1",])
    ...
    @pytest.mark.parametrize("device_a", ["device0", "device1",])
    @pytest.mark.parametrize("device_b", ["device0", "device1",])
